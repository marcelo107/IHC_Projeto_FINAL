...
public class Header extends HorizontalLayout {
    public Header() {
        ...
        logo.setSource(new ThemeResource("./images/uni3.png"));
        ...
        navBar.addItem("Ajuda", null, new MenuBar.Command() {
            @Override
            public void menuSelected(MenuItem selectedItem) {
            	MyUI.getCurrent().getNavigator().navigateTo("FAQ"); 
            	}
        });
        MenuItem home = navBar.addItem("", new ThemeResource("images/home.png"), new MenuBar.Command() {
			@Override
			public void menuSelected(MenuItem selectedItem) { MyUI.getCurrent().getNavigator().navigateTo("");}
		});
        home.setStyleName("menuRight");
        navBar.setWidth("100%");
        addComponent(navBar);
